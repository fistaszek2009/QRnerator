...
const link = `
<div style="position:fixed;top:12px;right:12px;opacity:0.7;z-index:5;">
  <a href="https://github.com/fistaszek2009/QRnerator" target="_blank" aria-label="GitHub repository">
    <svg height="25" width="25" viewBox="0 0 16 16" fill="white">
      ...
      .21.15.46.55.38A8.01 8.01 0 0016
